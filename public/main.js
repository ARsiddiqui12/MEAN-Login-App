...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_flashMessagesService, _AuthService, _Router) {
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(_flashMessagesService, _AuthService, _Router) {
        this._flashMessagesService = _flashMessagesService;
        this._AuthService = _AuthService;
        this._Router = _Router;
    }
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(_flashMessagesService, _AuthService, _Router) {
        this._flashMessagesService = _flashMessagesService;
        this._AuthService = _AuthService;
        this._Router = _Router;
    }
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(validservice, _flashMessagesService, _AuthService, _Router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validservice.validateRegister(user)) {
            ...
            this._flashMessagesService.show('please fill in all field!', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        if (!this.validservice.validateEmail(user.email)) {
            console.log("please enter a valid email!");
            this._flashMessagesService.show('please enter a valid email!', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        //registration process
        this._AuthService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this._flashMessagesService.show('You are now registered!', { cssClass: 'alert-success', timeout: 3000 });
                _this._Router.navigate(['/login']);
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.loggedIn = function () {
        return Object(angular2_jwt__WEBPACK_IMPORTED_MODULE_2__["tokenNotExpired"])(null, localStorage.getItem("id_token"));
    };
...
module.exports = __webpack_require__(/*! C:\Users\sweab\Desktop\MEAN Auth App\angular-src\src\main.ts */"./src/main.ts");
